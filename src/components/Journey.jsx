  ...
  return (
    <div>
      <div className="max-w-[95rem] mx-auto mb-28">
        ...
        {/* Journey 1 */}
        <div className="-skew-y-2 bg-[#EDEFFF] px-5 h-[21rem] overflow-hidden mb-7">
        ...
        {/* Journey 2 */}
        <div className="-skew-y-2 bg-[#FFF7E1] px-5 h-[21rem] overflow-hidden mb-7">
          <div className="skew-y-2 flex justify-between items-center">
            {/* write up */}
            <div className="flex space-x-5">
              <div>
        ...
        {/* Journey 3 */}
        <div className="-skew-y-2 bg-[#F3F3F3] px-5 h-[21rem] overflow-hidden">
          <div className="skew-y-2 flex justify-between items-center">
            {/* write up */}
            <div className="flex space-x-5">
              <div>
